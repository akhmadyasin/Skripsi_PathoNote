      ...
      <aside className={s.sidebar} id="sidebar">
        <div className={s.sbInner}>
          ...
          <nav className={s.nav} aria-label="Sidebar">
            ...
            <a className={`${s.navItem} ${isPathActive('/pasien') ? s.active : ''}`} href="/pasien"><svg viewBox="0 0 24 24" width="20" height="20" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M12 12c2.21 0 4-1.79 4-4s-1.79-4-4-4-4 1.79-4 4 1.79 4 4 4z"></path><path d="M4 20v-1c0-2.76 2.24-5 5-5h6c2.76 0 5 2.24 5 5v1"></path></svg><span>Pasien</span></a>
                ...
                <button
                  ...
                  onClick={() => {
                    if (typeof window !== 'undefined') {
                      sessionStorage.setItem('voicepanel-open-mic', 'true');
                    }
                    router.push('/voice');
                  }}
                  aria-pressed={false}
